﻿
/**
 * Библиотека взята с https://github.com/amcharts/amcharts3
 */
(function () {
    var d;
                ...
                if ("[object Array]" === Object.prototype.toString.call(a))
                    ...
                    try {
                        for (c in a.theme = null, a)
                            a[c] && ("object" == typeof a[c] && d.deleteObject(a[c],
        ...
        parseDatesDraw: function () {
            ...
            if (0 < this.gridCountR)
                for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                    ...
                    if (!isNaN(w))
                        for (g = 1; g < u; g += w)
                            this.gridAlpha = this.minorGridAlpha, f = p + x * g, f = d.resetDateToMin(new Date(f), A, w, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) *
    ...
    d.ValueAxis = d.Class({
        ...
        formatValue: function (a, b, c) {
            var e = this.exponential,
                ...
                h = this.chart;
            if (f)
                return !0 === this.logarithmic && (e = -1 != String(a).indexOf("e") ? !0 : !1), this.useScientificNotation && (e = !0), this.usePrefixes && (e = !1), e ? (c = -1 == String(a).indexOf("e") ? a.toExponential(15) : String(a), e = c.split("e"),
        ...
        stackGraphs: function (a) {
            ...
            for (p = this.start; p <= this.end; p++)
                for (q = 0; q < k.length; q++)
                    (n = k[q], n.hidden) ? n.newStack && (g[p] = NaN, e[p] = NaN) : (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable && (m = this.data[p].axes[this.id].graphs[n.id], h = m.values.value, isNaN(h) || (c = h / f[p] * 100, m.values.percents = c, m.values.total = f[p], n.newStack && (g[p] = NaN, e[p] = NaN), "100%" == b && (isNaN(e[p]) && (e[p] =
        ...
        getMinMax: function () {
            ...
            if (this.includeGuidesInMinMax && 0 < a)
                for (b = 0; b < a; b++)
                    c = this.guides[b], c.toValue < this.min && (this.min = c.toValue), c.value < this.min && (this.min = c.value), c.toValue > this.max && (this.max = c.toValue),
        ...
        construct: function (a, b, c, e, g, f, h, k, l, m, n, q) {
            ...
            if ("H" == Pa) {
                ...
                if (!0 === I && "left" == Z || !1 === I && "right" == Z)
                    ga = "start";
                v = b - Qa / 2 + 2;
                1 == ia && 0 < M && !h && !m && (e = d.fitToBounds(b, 0, X), da = d.fitToBounds(da, 0, X), V = e - da, Da = d.polygon(y,
    ...
    d.AmGraph = d.Class({
                        ...
                        case "line":
                            if (isNaN(W))
                                ...
                                if ($a || void 0 != v.lineColor && v.lineColor != this.lineColorSwitched || void 0 != v.fillColors && v.fillColors != this.fillColorsSwitched || !isNaN(v.dashLength))
                                    this.drawLineGraph(x, u, T, U), x = [E], u = [F], T = [], U = [], !Ma || isNaN(N) || isNaN(O) || (T.push(O), U.push(N)), m ? (Sa ? (this.lineColorSwitched = xa, this.fillColorsSwitched = wb) : (this.lineColorSwitched =
                            ...
                            if (!isNaN(ua) && !isNaN(W)) {
                                ...
                                if (t) {
                                    ...
                                    if (S < n && 0 < J) {
                                        ...
                                        !isNaN(ta) && !isNaN(ra) && E < n && 0 < E && (Xa = d.line(g, [E, E], Gb, Ca, X, da), cb = d.line(g,
        ...
        drawLineGraph: function (a, b, c, e) {
            ...
            if (1 < a.length) {
                ...
                void 0 === y || g.useNegativeColorIfDown || (p = d.line(l, a, b, y, r, p, x, !1,
                    !0, f), p.node.setAttribute("stroke-linejoin", "round"), d.setCN(k, p, g.bcn + "stroke"), d.setCN(k, p, g.bcn + "stroke-negative"), n.push(p));
                if (0 < h || 0 < A)
            ...
            if (k) {
                ...
                if (this.resizingLeft) {
                    if (m)
                        ...
                        !isNaN(this.maxWidth) && a > this.maxWidth && (a = this.maxWidth, e = c), 0 > a)
            ...
            if (this.categoryAxis && "ValueAxis" == this.categoryAxis.cname)
                ...
                if (k.parseDates && !k.equalSpacing) {
                    ...
                    if (g != this.start || this.end != b)
                        k.startOnAxis && (this.resizingRight && g == b && b++, this.resizingLeft && g == b && (0 < g ? g-- : b = 1)), this.start = g, this.end = this.dragging ? this.start + this.difference : b, f.start = this.start, f.end = this.end, k.parseDates && (a[this.start] && (f.startDate = new Date(a[this.start].time)), a[this.end] && (f.endDate = new Date(a[this.end].time))),
                            this.fire(f);
                    this.percentStart = g;
                    this.percentEnd = b
                }
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (e) {
                    ...
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e)
                        m = q.set(), a.hidden || (f = a.lineColorR, k = a.bulletBorderColorR), t = d.line(q, [0, 2 * p], [p / 2, p / 2], f,
